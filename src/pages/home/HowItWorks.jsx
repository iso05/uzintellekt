...
const HowItWorks = () => {
  return (
    <section className="relative how-bg py-28 overflow-hidden">
      {/* BACK ILLUSTRATION */}
      <div className="how-illustration" />

      <div className="relative max-w-7xl mx-auto px-6">
        {/* TITLE */}
        <h2 className="text-3xl md:text-4xl font-bold gradient-title mb-16 pb-3">
          Qanday ishlaydi
        </h2>

        {/* STEPS */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-13 relative">
          {steps.map((item, idx) => (
            <div
              key={idx}
              className="how-card relative"
            >
              {/* STEP NUMBER */}
